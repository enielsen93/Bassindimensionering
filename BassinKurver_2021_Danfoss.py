...
concentration_times = [10]#[0, 7, 10, 14, 30, 60, 100]
...
# Udløbstal
udlobstal = [170/(2.05*1.425)]#np.logspace(np.log2(0.25), np.log2(1000), num = 30, base = 2) # L/s/ha
...
for concentration_time_i, concentration_time in enumerate(concentration_times):
    ...
    [gaugetime, gaugeint] = readKM2.readKM2(
        ...
        initial_loss = 0.6, concentration_time = 10)
...
print(np.interp(5, RP, VRP.flatten())*1.425*2.05*10)
